...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(nn.init.xavier_normal_(torch.empty((
            self.embed_size*n_features, self.hidden_size))))
    ...
    def forward(self, w):
        ...
        h = torch.matmul(embed, self.embed_to_hidden_weight)+self.embed_to_hidden_bias
